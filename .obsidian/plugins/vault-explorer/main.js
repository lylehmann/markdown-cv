...
// src/types/index.ts
var TExplorerView = /* @__PURE__ */ ((TExplorerView3) => {
  TExplorerView3["DASHBOARD"] = "dashboard";
  TExplorerView3["GRID"] = "grid";
  TExplorerView3["LIST"] = "list";
  TExplorerView3["FEED"] = "feed";
  TExplorerView3["TABLE"] = "table";
  TExplorerView3["RECOMMENDED"] = "recommended";
  TExplorerView3["RELATED"] = "related";
  return TExplorerView3;
})(TExplorerView || {});
...
var FilterRuleType = /* @__PURE__ */ ((FilterRuleType2) => {
  FilterRuleType2["PROPERTY"] = "property";
  FilterRuleType2["FOLDER"] = "folder";
  FilterRuleType2["FILE_NAME"] = "file-name";
  FilterRuleType2["CONTENT"] = "content";
  return FilterRuleType2;
})(FilterRuleType || {});
...
var randomGroupId = generateRandomId();
...
function init(component, options, instance41, create_fragment43, not_equal, props, append_styles = null, dirty = [-1]) {
...
var Spacer = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance9, create_fragment9, safe_not_equal, { direction: 2, size: 3 });
  }
};
...
var Property = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance10, create_fragment10, safe_not_equal, { name: 2, value: 3 });
  }
};
...
var getScrollAmount = (containerRef, className, direction) => {
  ...
  if (direction === "right") {
    for (let i = 0; i < items.length; i++) {
      ...
      const containerRight = containerRef.scrollLeft + containerRef.clientWidth - BUTTON_WIDTH - BUTTON_DISTANCE;
...
var getItemRight = (item) => item.offsetLeft + item.getBoundingClientRect().width;
...
// src/svelte/shared/components/scroll-button.svelte
function create_fragment12(ctx) {
  ...
  iconbutton = new icon_button_default({
    props: {
      ...
      ariaLabel: (
        /*direction*/
        ctx[0] === "left" ? "Scroll left" : "Scroll right"
      ),
      noPadding: true,
      iconId: (
        /*direction*/
        ctx[0] === "left" ? "chevron-left" : "chevron-right"
      )
    }
  });
  iconbutton.$on(
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & /*direction*/
      1)
        iconbutton_changes.ariaLabel = /*direction*/
        ctx2[0] === "left" ? "Scroll left" : "Scroll right";
      if (dirty & /*direction*/
      1)
        iconbutton_changes.iconId = /*direction*/
        ctx2[0] === "left" ? "chevron-left" : "chevron-right";
...
function instance12($$self, $$props, $$invalidate) {
  ...
  function getClassName() {
    let className2 = `vault-explorer-scroll-button vault-explorer-scroll-button--${direction}`;
    if (type === "group-tag") {
      className2 += " vault-explorer-scroll-button--group-tag";
    } else {
      className2 += " vault-explorer-scroll-button--tag";
    }
    return className2;
  }
  ...
  $:
    $$invalidate(1, className = getClassName());
  return [direction, className, type, click_handler];
}
var Scroll_button = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance12, create_fragment12, safe_not_equal, { direction: 0, type: 2 });
  }
};
var scroll_button_default = Scroll_button;
...
function create_if_block_3(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      const stack_changes = {};
      if (dirty & /*$$scope, renderScrollRightButton, tagContainerRef, tags, renderScrollLeftButton*/
      16778888) {
        stack_changes.$$scope = { dirty, ctx: ctx2 };
      }
      stack.$set(stack_changes);
...
function create_if_block_5(ctx) {
  let scrollbutton;
  let current;
  scrollbutton = new scroll_button_default({
    props: { type: "tag", direction: "left" }
  });
  scrollbutton.$on(
    "click",
...
function create_if_block_4(ctx) {
  ...
  let current;
  scrollbutton = new scroll_button_default({
    props: { type: "tag", direction: "right" }
  });
  scrollbutton.$on(
    "click",
...
function create_default_slot_1(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "vault-explorer-grid-card__tags svelte-d687dr");
    },
    m(target, anchor) {
      if (if_block0)
    ...
    p(ctx2, dirty) {
      if (
        ...
        if (if_block0) {
          ...
          if (dirty & /*renderScrollLeftButton*/
          512) {
      ...
      if (
        ...
        if (if_block1) {
          ...
          if (dirty & /*renderScrollRightButton*/
          1024) {
...
function create_if_block_2(ctx) {
  ...
  property = new property_default({
    props: {
      name: (
        /*plugin*/
        ctx[11].settings.properties.custom1
      ),
      value: (
        /*custom1*/
        ctx[4]
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      2048)
        ...
        ctx2[11].settings.properties.custom1;
      if (dirty & /*custom1*/
      16)
...
function create_if_block_1(ctx) {
  ...
  property = new property_default({
    props: {
      name: (
        /*plugin*/
        ctx[11].settings.properties.custom2
      ),
      value: (
        /*custom2*/
        ctx[5]
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      2048)
        property_changes.name = /*plugin*/
        ctx2[11].settings.properties.custom2;
      if (dirty & /*custom2*/
      32)
...
function create_if_block(ctx) {
  ...
  property = new property_default({
    props: {
      name: (
        /*plugin*/
        ctx[11].settings.properties.custom3
      ),
      value: (
        /*custom3*/
        ctx[6]
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      2048)
        property_changes.name = /*plugin*/
        ctx2[11].settings.properties.custom3;
      if (dirty & /*custom3*/
      64)
...
function create_default_slot2(ctx) {
  ...
  let if_block1 = (
    /*custom2*/
    ctx[5] !== null && create_if_block_1(ctx)
  );
  let if_block2 = (
    /*custom3*/
    ctx[6] !== null && create_if_block(ctx)
  );
  return {
    c() {
      if (if_block0)
...
function create_fragment13(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "role", "link");
      attr(div0, "class", "vault-explorer-grid-card__title svelte-d687dr");
      attr(div0, "style", div0_style_value = `word-break: ${/*wordBreak*/
      ctx[8]};`);
      attr(div1, "class", "vault-explorer-grid-card__header svelte-d687dr");
      attr(div2, "class", "vault-explorer-grid-card__content svelte-d687dr");
      attr(div3, "class", "vault-explorer-grid-card svelte-d687dr");
    },
    m(target, anchor) {
...
function instance13($$self, $$props, $$invalidate) {
  ...
  let plugin2;
  store_default.plugin.subscribe((p) => {
    $$invalidate(11, plugin2 = p);
    $$invalidate(8, wordBreak = plugin2.settings.views.titleWrapping);
    $$invalidate(16, enableScrollButtons = plugin2.settings.enableScrollButtons);
  });
  onMount(() => {
  ...
  onMount(() => {
    function handleScrollButtonSettingChange() {
      const newValue = plugin2.settings.enableScrollButtons;
      $$invalidate(16, enableScrollButtons = newValue);
      if (newValue === false) {
        $$invalidate(9, renderScrollLeftButton = false);
        $$invalidate(10, renderScrollRightButton = false);
      }
    }
    EventManager.getInstance().on("scroll-buttons-setting-change", handleScrollButtonSettingChange);
    return () => {
      EventManager.getInstance().off("scroll-buttons-setting-change", handleScrollButtonSettingChange);
    };
  });
  onMount(() => {
  ...
  function handleScrollLeftClick() {
    if (tagContainerRef) {
      const scrollAmount = getScrollAmount(tagContainerRef, ".vault-explorer-tag", "left");
      tagContainerRef.scrollBy({ left: -scrollAmount, behavior: "smooth" });
    }
  }
  function handleScrollRightClick() {
    if (tagContainerRef) {
      const scrollAmount = getScrollAmount(tagContainerRef, ".vault-explorer-tag", "right");
      tagContainerRef.scrollBy({ left: scrollAmount, behavior: "smooth" });
    }
  }
  function handleScroll() {
    ...
    $$invalidate(9, renderScrollLeftButton = scrollLeft > 0);
    $$invalidate(10, renderScrollRightButton = Math.round(scrollLeft + clientWidth) < scrollWidth);
  }
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*tagContainerRef, enableScrollButtons*/
    65664) {
      $:
        if (tagContainerRef) {
...
var Grid_view = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance14, create_fragment14, safe_not_equal, { data: 1, startIndex: 2, pageLength: 3 });
  }
};
...
var List_item = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance15, create_fragment15, safe_not_equal, { name: 0, path: 1 });
  }
};
...
var List_view = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance16, create_fragment16, safe_not_equal, { data: 1, startIndex: 2, pageLength: 3 });
  }
};
...
var filterBySearch = (file, value) => {
  ...
  if (tags !== null && tags.some(
    (tag) => tag.toLowerCase().includes(compare)
  )) {
    return true;
  }
...
var getStartOfThisWeekMillis = () => {
  return (0, import_obsidian4.moment)().startOf("week").valueOf();
};
var getMomentDate = (date) => {
  return (0, import_obsidian4.moment)(date, DATE_FORMATS, true);
};
var getDateDaysAgo = (daysAgo) => {
  return (0, import_obsidian4.moment)().subtract(daysAgo, "days").format("YYYY-MM-DD");
};
var getDateDaysAhead = (daysAgo) => {
  return (0, import_obsidian4.moment)().add(daysAgo, "days").format("YYYY-MM-DD");
};
var getStartOfLastWeekMillis = () => {
  return (0, import_obsidian4.moment)().subtract(1, "weeks").startOf("week").valueOf();
};
var getTimeMillis = (date) => {
  const momentDate = (0, import_obsidian4.moment)(date, DATE_FORMATS, true);
...
var loadPropertyValue = (frontmatter, propertyName, expectedType) => {
  ...
  if (expectedType === "text" /* TEXT */) {
    if (typeof propertyValue !== "string") {
      import_js_logger2.default.warn(`Property value of type 'text' is not a string: ${propertyValue}`);
      return null;
    }
  } else if (expectedType === "number" /* NUMBER */) {
    if (typeof propertyValue !== "number") {
      import_js_logger2.default.warn(`Property value of type 'number' is not a number: ${propertyValue}`);
      return null;
    }
  } else if (expectedType === "date" /* DATE */) {
    if (typeof propertyValue !== "string") {
      import_js_logger2.default.warn(`Property value of type 'date' is not a string: ${propertyValue}`);
      return null;
    }
  } else if (expectedType === "datetime" /* DATETIME */) {
    if (typeof propertyValue !== "string") {
      import_js_logger2.default.warn(`Property value of type 'datetime' is not a string: ${propertyValue}`);
      return null;
    }
  } else if (expectedType === "checkbox" /* CHECKBOX */) {
    if (typeof propertyValue !== "boolean") {
      import_js_logger2.default.warn(`Property value of type 'checkbox' is not a boolean: ${propertyValue}`);
      return null;
    }
  } else if (expectedType === "list" /* LIST */) {
    if (!Array.isArray(propertyValue)) {
      import_js_logger2.default.warn(`Property value of type 'list' is not an array: ${propertyValue}`);
    }
  }
  if (expectedType === "date" /* DATE */) {
    if (!isDateSupported(propertyValue)) {
      import_js_logger2.default.warn(`Property value of type 'date' has unsupported date format: ${propertyValue}`);
      return null;
    }
  } else if (expectedType === "datetime" /* DATETIME */) {
    if (!isDateSupported(propertyValue)) {
      import_js_logger2.default.warn(`Property value of type 'datetime' has unsupported date format: ${propertyValue}`);
      return null;
    }
  }
...
// src/svelte/app/services/frontmatter-utils.ts
var removeFrontmatterBlock = (data) => {
  return data.replace(/^---\n[\s\S]*?\n---/, "").trim();
};
...
var filterByPropertyType = (frontmatter, filter) => {
  ...
  if (propertyType === "text") {
    let propertyValue = loadPropertyValue(frontmatter, propertyName, propertyType);
    if (propertyValue) {
    ...
    const propertyValue = loadPropertyValue(frontmatter, propertyName, propertyType);
...
var formatFileDataForRender = (settings, file, frontmatter, content) => {
  const tags = loadPropertyValue(frontmatter, "tags", "list" /* LIST */);
  const {
  ...
  const url = loadPropertyValue(frontmatter, urlProp, "text" /* TEXT */);
  const favorite = loadPropertyValue(frontmatter, favoriteProp, "checkbox" /* CHECKBOX */);
  const creationDate = loadPropertyValue(frontmatter, createdDateProp, "date" /* DATE */ || "datetime" /* DATETIME */);
  const modifiedDate = loadPropertyValue(frontmatter, modifiedDateProp, "date" /* DATE */ || "datetime" /* DATETIME */);
  const custom1 = loadPropertyValue(frontmatter, custom1Prop, "text" /* TEXT */);
  const custom2 = loadPropertyValue(frontmatter, custom2Prop, "text" /* TEXT */);
  const custom3 = loadPropertyValue(frontmatter, custom3Prop, "text" /* TEXT */);
  let createdMillis = file.stat.ctime;
  if (creationDate != null) {
    if (isDateSupported(creationDate)) {
      createdMillis = getTimeMillis(creationDate);
    } else {
      import_js_logger3.default.warn(`Property value has unsupported date format: ${creationDate}`);
    }
  }
...
var Search_filter = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance17, create_fragment17, safe_not_equal, { value: 0 });
  }
};
...
var Timestamp_filter = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance18, create_fragment18, safe_not_equal, { value: 1 });
  }
};
...
var Sort_filter = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance19, create_fragment19, safe_not_equal, { value: 1 });
  }
};
...
var Divider = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance20, create_fragment20, safe_not_equal, { direction: 2, borderWidth: 0 });
  }
};
var divider_default = Divider;

// src/svelte/properties-filter-app/components/display-name-utils.ts
...
var Switch = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance21, create_fragment21, safe_not_equal, { ariaLabel: 0, value: 1, id: 2 });
  }
};
...
var loadDeviceId = () => {
  import_js_logger4.default.trace({ fileName: "license-utils.ts", functionName: "loadDeviceId", message: "called" });
  const deviceId = localStorage.getItem(LOCAL_STORAGE_KEY);
  if (deviceId !== null) {
    import_js_logger4.default.trace({ fileName: "license-utils.ts", functionName: "loadDeviceId", message: "found device id" });
  } else {
    import_js_logger4.default.trace({ fileName: "license-utils.ts", functionName: "loadDeviceId", message: "creating device id" });
    const newDeviceId = generateRandomDeviceId();
    localStorage.setItem(LOCAL_STORAGE_KEY, newDeviceId);
  }
};
var readDeviceId = () => {
  import_js_logger4.default.trace({ fileName: "license-utils.ts", functionName: "readDeviceId", message: "called" });
  const deviceId = localStorage.getItem(LOCAL_STORAGE_KEY);
  if (deviceId === null) {
...
var License = class {
  constructor() {
    ...
    this.licenseKey = (_a = localStorage.getItem(LOCAL_STORAGE_LICENSE_KEY)) != null ? _a : "";
  }
  async registerDevice(licenseKey) {
    import_js_logger5.default.trace({ fileName: "license.ts", functionName: "registerDevice", message: "called" });
  ...
  async unregisterDevice() {
    import_js_logger5.default.trace({ fileName: "license.ts", functionName: "unregisterDevice", message: "called" });
    const deviceId = readDeviceId();
  ...
  async verifyLicense() {
    import_js_logger5.default.trace({ fileName: "license.ts", functionName: "verifyLicense", message: "called" });
    if (this.licenseKey === "") {
      import_js_logger5.default.debug({ fileName: "license.ts", functionName: "verifyLicense", message: "no license key set. returning..." });
      return;
    } else if (this.licenseKey.length !== LICENSE_KEY_LENGTH) {
      import_js_logger5.default.debug({ fileName: "license.ts", functionName: "verifyLicense", message: "license key is not the correct length. returning..." });
      return;
    }
    const deviceId = readDeviceId();
  ...
  async postVerifyDevice(licenseKey, deviceId) {
    import_js_logger5.default.trace({ fileName: "license.ts", functionName: "postVerifyDevice", message: "called" });
    try {
      ...
      import_js_logger5.default.debug({ fileName: "license.ts", functionName: "postVerifyDevice", message: "response" }, body);
      return true;
    } catch (err) {
      const error = err;
      import_js_logger5.default.error({ fileName: "license.ts", functionName: "postVerifyDevice", message: "error verifying device" }, error.message);
      return false;
    }
  }
  async postRegisterDevice(licenseKey, deviceId) {
    import_js_logger5.default.trace({ fileName: "license.ts", functionName: "postRegisterDevice", message: "called" });
    try {
      const response = await (0, import_obsidian7.requestUrl)({
      ...
      const body = response.json;
      import_js_logger5.default.debug({ fileName: "license.ts", functionName: "postRegisterDevice", message: "response" }, body);
      ...
      import_js_logger5.default.error({ fileName: "license.ts", functionName: "postRegisterDevice", message: "error registering device" }, error.message);
      return false;
    }
  }
  async postUnregisterDevice(licenseKey, deviceId) {
    import_js_logger5.default.trace({ fileName: "license.ts", functionName: "postUnregisterDevice", message: "called" });
    try {
      const response = await (0, import_obsidian7.requestUrl)({
      ...
      const body = response.json;
      import_js_logger5.default.debug({ fileName: "license.ts", functionName: "postUnregisterDevice", message: "response" }, body);
      this.responseMessage = "";
      return true;
    } catch (err) {
      const error = err;
      ...
      this.responseMessage = message;
      import_js_logger5.default.error({ fileName: "license.ts", functionName: "postUnregisterDevice", message: "error unregistering device" }, error.message);
      return false;
    }
  }
  setLicenseKey(value) {
...
// src/svelte/properties-filter-app/components/filter-rule.svelte
...
function create_default_slot3(ctx) {
  ...
  return {
    c() {
      ...
      ctx[3] === "content" /* CONTENT */ && !/*enablePremiumFeatures*/
      ctx[5];
    ...
    p(ctx2, dirty) {
      ...
      if (!current || dirty & /*type, enablePremiumFeatures, Object*/
      40 && select1_disabled_value !== (select1_disabled_value = /*type*/
      ctx2[3] === "content" /* CONTENT */ && !/*enablePremiumFeatures*/
      ctx2[5])) {
...
function create_fragment22(ctx) {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      const wrap_changes = {};
      if (dirty & /*$$scope, isEnabled, type, enablePremiumFeatures, condition, filterConditions, operator, index*/
      131199) {
        wrap_changes.$$scope = { dirty, ctx: ctx2 };
      }
      wrap.$set(wrap_changes);
...
function instance22($$self, $$props, $$invalidate) {
  ...
  License.getInstance().getIsDeviceRegisteredStore().subscribe((isRegistered) => {
    $$invalidate(5, enablePremiumFeatures = isRegistered);
  });
...
function create_after_condition_slot(ctx) {
  ...
  let if_block2 = (
    ...
    ctx[3] !== "datetime" /* DATETIME */ && /*condition*/
    ctx[6] !== "exists" /* EXISTS */ && /*condition*/
    ctx[6] !== "does-not-exist" /* DOES_NOT_EXIST */ && create_if_block_22(ctx)
  );
  let if_block3 = (
    /*propertyType*/
    (ctx[3] === "date" /* DATE */ || /*propertyType*/
    ...
    ctx[6] !== "exists" /* EXISTS */ && /*condition*/
    ctx[6] !== "does-not-exist" /* DOES_NOT_EXIST */ && create_if_block_12(ctx)
  );
  let if_block4 = (
    /*condition*/
    ctx[6] !== "exists" /* EXISTS */ && /*condition*/
    ctx[6] !== "does-not-exist" /* DOES_NOT_EXIST */ && create_if_block4(ctx)
  );
  return {
    c() {
      if (if_block0)
...
function create_fragment25(ctx) {
  ...
  return {
    c() {
      div = element("div");
      div.textContent = "You must have a premium license to use this feature";
...
// src/svelte/properties-filter-app/components/content-filter.svelte
function create_if_block_13(ctx) {
  ...
  return {
    c() {
      input = element("input");
      attr(input, "type", "text");
      input.disabled = input_disabled_value = !/*enablePremiumFeatures*/
      ctx[7];
    ...
    p(ctx2, dirty) {
      if (dirty & /*enablePremiumFeatures*/
      128 && input_disabled_value !== (input_disabled_value = !/*enablePremiumFeatures*/
      ctx2[7])) {
...
function create_after_condition_slot2(ctx) {
  ...
  let if_block = (
    ...
    ctx[5] !== "is-not-empty" /* IS_NOT_EMPTY */ && create_if_block_13(ctx)
  );
  return {
    c() {
      if (if_block)
...
function create_after_toggle_slot(ctx) {
  ...
  let if_block = (
    /*type*/
    ctx[2] === "content" /* CONTENT */ && !/*enablePremiumFeatures*/
  ...
  return {
    ...
    p(ctx2, dirty) {
      if (
        /*type*/
        ctx2[2] === "content" /* CONTENT */ && !/*enablePremiumFeatures*/
        ctx2[7]
      ) {
        if (if_block) {
          if (dirty & /*type, enablePremiumFeatures*/
          132) {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      64)
        filterrule_changes.isEnabled = /*isEnabled*/
        ctx2[6];
      if (dirty & /*$$scope, type, enablePremiumFeatures, value, condition*/
      32940) {
        filterrule_changes.$$scope = { dirty, ctx: ctx2 };
      }
      filterrule.$set(filterrule_changes);
...
function instance24($$self, $$props, $$invalidate) {
  ...
  let enablePremiumFeatures = false;
  License.getInstance().getIsDeviceRegisteredStore().subscribe((isRegistered) => {
    $$invalidate(7, enablePremiumFeatures = isRegistered);
  });
  function handleValueChange(e) {
    const value2 = e.target.value;
    dispatch("ruleValueChange", { id, value: value2 });
...
var Content_filter = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance24, create_fragment26, safe_not_equal, {
      index: 0,
      id: 1,
      type: 2,
      value: 3,
...
// src/svelte/properties-filter-app/components/folder-filter.svelte
...
function instance25($$self, $$props, $$invalidate) {
  ...
  store_default.plugin.subscribe((p) => {
    ...
    $$invalidate(8, folders = allFiles.filter((file) => file instanceof import_obsidian8.TFolder).map((folder) => folder.path));
  });
  onMount(() => {
    const handleFolderRename = (...data) => {
      if (data.length < 2)
        return;
      if (typeof data[0] === "string" && data[1] instanceof import_obsidian8.TFolder) {
...
var Folder_filter = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance25, create_fragment27, safe_not_equal, {
      index: 0,
      id: 1,
      type: 2,
      value: 3,
...
// src/svelte/properties-filter-app/components/file-name-filter.svelte
...
// src/svelte/properties-filter-app/components/filter-rule-list.svelte
...
function create_if_block_33(ctx) {
  ...
  const propertyfilter_spread_levels = [
    ...
    /*rule*/
    ctx[30].propertyType === "date" /* DATE */ ? { valueData: (
      /*rule*/
      ctx[30].valueData
    ) } : { valueData: null },
    { condition: (
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      1 ? get_spread_update(propertyfilter_spread_levels, [
        ...
        get_spread_object(
          /*rule*/
          ctx2[30].propertyType === "date" /* DATE */ ? { valueData: (
            /*rule*/
            ctx2[30].valueData
          ) } : { valueData: null }
        ),
        ...
        ) },
        {
          matchWhenPropertyDNE: (
            /*rule*/
            ctx2[30].matchWhenPropertyDNE
          )
        },
        {
          propertyType: (
            /*rule*/
            ctx2[30].propertyType
          )
        },
        { isEnabled: (
          /*rule*/
...
function create_each_block7(key_1, ctx) {
  ...
  let if_block0 = (
    /*rule*/
    ctx[30].type === "property" /* PROPERTY */ && create_if_block_33(ctx)
  );
  let if_block1 = (
    /*rule*/
    ctx[30].type === "file-name" /* FILE_NAME */ && create_if_block_23(ctx)
  );
  let if_block2 = (
    /*rule*/
    ctx[30].type === "folder" /* FOLDER */ && create_if_block_14(ctx)
  );
  let if_block3 = (
    /*rule*/
    ctx[30].type === "content" /* CONTENT */ && create_if_block6(ctx)
  );
  return {
    key: key_1,
    first: null,
    ...
    p(new_ctx, dirty) {
      ...
      if (
        /*rule*/
        ctx[30].type === "file-name" /* FILE_NAME */
      ) {
        if (if_block1) {
...
var Filter_rule_list = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance27, create_fragment29, safe_not_equal, { rules: 0 }, null, [-1, -1]);
  }
};
...
function create_default_slot5(ctx) {
  ...
  let if_block = (
    /*selectedGroup*/
    ctx[0].rules.length > 0 && create_if_block7(ctx)
  );
  iconbutton = new icon_button_default({
    props: {
...
var Group_edit_view = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance28, create_fragment30, safe_not_equal, { selectedGroup: 0 });
  }
};
...
var Group_list_item = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance29, create_fragment31, safe_not_equal, { id: 6, name: 0, isSelected: 7 });
  }
};
...
var Group_list = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance30, create_fragment32, safe_not_equal, { groups: 0, selectedGroup: 1 });
  }
};
...
function create_default_slot7(ctx) {
  ...
  let if_block = (
    /*selectedGroup*/
    ctx[1] !== void 0 && create_if_block8(ctx)
  );
  return {
    c() {
...
function instance31($$self, $$props, $$invalidate) {
  ...
  store_default.plugin.subscribe((p) => {
    ...
    $$invalidate(19, selectedGroupId = plugin2.settings.filters.custom.selectedGroupId);
  });
  onMount(() => {
    return () => {
  ...
  function handleGroupClick(e) {
    const { id } = e.detail;
    $$invalidate(19, selectedGroupId = id);
  }
  function handleGroupAddClick() {
    const newGroup = {
      id: generateRandomId(),
    ...
    $$invalidate(19, selectedGroupId = newGroup.id);
  ...
  function handleGroupDeleteClick() {
    ...
    if (newGroups.length === 0) {
      $$invalidate(19, selectedGroupId = "");
    } else {
      $$invalidate(19, selectedGroupId = newGroups[newIndex].id);
    }
  }
...
var Properties_filter_app = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance31, create_fragment33, safe_not_equal, {});
  }
};
var properties_filter_app_default = Properties_filter_app;

// src/obsidian/properties-filter-modal.ts
var PropertiesFilterModal = class extends import_obsidian9.Modal {
  constructor(plugin2) {
    super(plugin2.app);
    this.plugin = plugin2;
    this.component = null;
...
function instance32($$self, $$props, $$invalidate) {
  ...
  onMount(() => {
    if (iconId === "ellipsis-vertical")
      return;
    (0, import_obsidian10.setIcon)(ref, iconId);
  ...
  $$self.$$set = ($$props2) => {
    if ("ariaLabel" in $$props2)
      $$invalidate(0, ariaLabel = $$props2.ariaLabel);
    if ("iconId" in $$props2)
      $$invalidate(3, iconId = $$props2.iconId);
    if ("xs" in $$props2)
      $$invalidate(4, xs = $$props2.xs);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*xs*/
    16) {
      $:
        $$invalidate(2, className = `vault-explorer-icon ${xs ? "vault-explorer-icon--xs" : ""}`);
    }
  };
  return [ariaLabel, ref, className, iconId, xs, div_binding];
}
var Icon = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance32, create_fragment34, safe_not_equal, { ariaLabel: 0, iconId: 3, xs: 4 });
  }
};
...
function create_default_slot8(ctx) {
  ...
  icon = new icon_default({
    props: { iconId: "sticky-note", xs: true }
  });
  return {
    c() {
...
function create_if_block_16(ctx) {
  ...
  let current;
  scrollbutton = new scroll_button_default({
    props: { type: "group-tag", direction: "left" }
  });
  scrollbutton.$on(
    "click",
    /*handleScrollLeftClick*/
...
function create_if_block10(ctx) {
  ...
  let current;
  scrollbutton = new scroll_button_default({
    props: { type: "group-tag", direction: "right" }
  });
  scrollbutton.$on(
    "click",
    /*handleScrollRightClick*/
...
function create_fragment36(ctx) {
  ...
  return {
    c() {
      ...
      if (if_block1)
        if_block1.c();
      attr(div0, "class", "vault-explorer-group-tag-list__container svelte-1c57v79");
      attr(div1, "class", "vault-explorer-group-tag-list svelte-1c57v79");
    },
    m(target, anchor) {
      insert(target, div1, anchor);
      append(div1, div0);
...
function instance34($$self, $$props, $$invalidate) {
  ...
  onMount(() => {
    store_default.plugin.subscribe((value) => {
      plugin2 = value;
      $$invalidate(6, enableScrollButtons = plugin2.settings.enableScrollButtons);
    });
  });
  onMount(() => {
    function handleScrollButtonSettingChange() {
      const newValue = plugin2.settings.enableScrollButtons;
      $$invalidate(6, enableScrollButtons = newValue);
      if (newValue === false) {
        $$invalidate(2, showScrollLeftButton = false);
        $$invalidate(3, showScrollRightButton = false);
      }
    }
    EventManager.getInstance().on("scroll-buttons-setting-change", handleScrollButtonSettingChange);
    return () => {
  ...
  function handleScroll() {
    if (!tagContainerRef)
      return;
    const { scrollLeft, clientWidth, scrollWidth } = tagContainerRef;
    $$invalidate(2, showScrollLeftButton = scrollLeft > 0);
    $$invalidate(3, showScrollRightButton = Math.round(scrollLeft + clientWidth) < scrollWidth);
  }
  function handleScrollLeftClick() {
    if (tagContainerRef) {
      const scrollAmount = getScrollAmount(tagContainerRef, ".vault-explorer-group-tag", "left");
      tagContainerRef.scrollBy({ left: -scrollAmount, behavior: "smooth" });
    }
  }
  function handleScrollRightClick() {
    if (tagContainerRef) {
      const scrollAmount = getScrollAmount(tagContainerRef, ".vault-explorer-group-tag", "right");
      tagContainerRef.scrollBy({ left: scrollAmount, behavior: "smooth" });
    }
  }
...
var Group_tag_list = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance34, create_fragment36, safe_not_equal, { groups: 0 });
  }
};
var group_tag_list_default = Group_tag_list;

// src/svelte/app/components/custom-filter.svelte
function create_if_block_17(ctx) {
  let grouptaglist;
  let current;
  grouptaglist = new group_tag_list_default({ props: { groups: (
    /*groups*/
    ctx[0]
  ) } });
  grouptaglist.$on(
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty & /*groups*/
      1)
        grouptaglist_changes.groups = /*groups*/
        ctx2[0];
...
function create_if_block11(ctx) {
  ...
  return {
    c() {
      ...
      attr(span, "class", "vault-explorer-empty-label svelte-1y5znhr");
    },
    m(target, anchor) {
...
function create_default_slot10(ctx) {
  ...
  let if_block0 = (
    /*groups*/
    ctx[0].length > 0 && create_if_block_17(ctx)
  );
  let if_block1 = (
    /*groups*/
    ctx[0].length === 0 && create_if_block11(ctx)
  );
  iconbutton = new icon_button_default({
    props: {
...
function create_fragment37(ctx) {
  ...
  return {
    c() {
      div = element("div");
      create_component(stack.$$.fragment);
      attr(div, "class", "vault-explorer-custom-filter svelte-1y5znhr");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      mount_component(stack, div, null);
...
var Custom_filter = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance35, create_fragment37, safe_not_equal, { groups: 0 });
  }
};
var custom_filter_default = Custom_filter;
...
var formatBearTime = (milliseconds) => {
  const now2 = (0, import_obsidian11.moment)();
  const time = (0, import_obsidian11.moment)(milliseconds);
...
function create_if_block_18(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "vault-explorer-feed-card__content svelte-1fmu0v7");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, t);
...
function create_if_block12(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "vault-explorer-feed-card__tags svelte-1fmu0v7");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      for (let i = 0; i < each_blocks.length; i += 1) {
...
function create_default_slot11(ctx) {
  ...
  let if_block0 = (
    /*content*/
    ctx[3] != null && /*content*/
    ctx[3].length > 0 && create_if_block_18(ctx)
  );
  let if_block1 = (
    /*tags*/
    ctx[2] != null && create_if_block12(ctx)
  );
  return {
    c() {
      div0 = element("div");
      ...
      t3 = space();
      div1 = element("div");
      div1.textContent = `${/*creationString*/
      ctx[7]}`;
      attr(div0, "tabindex", "0");
      attr(div0, "role", "link");
      attr(div0, "class", "vault-explorer-feed-card__title svelte-1fmu0v7");
      attr(div0, "style", div0_style_value = `word-break: ${/*wordBreak*/
      ctx[4]};`);
      attr(div1, "class", "vault-explorer-feed-card__creation-time svelte-1fmu0v7");
    },
    m(target, anchor) {
      insert(target, div0, anchor);
      append(div0, t0);
      ...
      if (!mounted) {
        dispose = [
          listen(div0, "focus", focus_handler3),
          listen(
            div0,
            "click",
            /*handleTitleClick*/
    ...
    p(ctx2, dirty) {
      ...
      if (!current || dirty & /*wordBreak*/
      16 && div0_style_value !== (div0_style_value = `word-break: ${/*wordBreak*/
      ctx2[4]};`)) {
        attr(div0, "style", div0_style_value);
      }
      if (
...
function create_fragment38(ctx) {
  ...
  return {
    c() {
      div = element("div");
      create_component(stack.$$.fragment);
      attr(div, "class", "vault-explorer-feed-card svelte-1fmu0v7");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      mount_component(stack, div, null);
    ...
    p(ctx2, [dirty]) {
      const stack_changes = {};
      if (dirty & /*$$scope, tags, content, wordBreak, plugin, path, name*/
      65599) {
        stack_changes.$$scope = { dirty, ctx: ctx2 };
      }
      stack.$set(stack_changes);
...
function instance36($$self, $$props, $$invalidate) {
  ...
  let plugin2;
  store_default.plugin.subscribe((value) => {
    $$invalidate(5, plugin2 = value);
    $$invalidate(4, wordBreak = plugin2.settings.views.titleWrapping);
  });
  onMount(() => {
    function handleTitleWrappingSettingChange() {
      $$invalidate(4, wordBreak = plugin2.settings.views.titleWrapping);
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("path" in $$props2)
      $$invalidate(1, path = $$props2.path);
    if ("url" in $$props2)
      $$invalidate(8, url = $$props2.url);
    if ("tags" in $$props2)
      $$invalidate(2, tags = $$props2.tags);
    if ("createdMillis" in $$props2)
      $$invalidate(9, createdMillis = $$props2.createdMillis);
...
var Feed_card = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance36, create_fragment38, safe_not_equal, {
      name: 0,
      path: 1,
      url: 8,
      tags: 2,
...
function create_each_block11(key_1, ctx) {
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      if (dirty & /*displayedItems*/
      2)
        feedcard_changes.name = /*fileData*/
        ctx[5].name;
      if (dirty & /*displayedItems*/
      2)
        feedcard_changes.path = /*fileData*/
        ctx[5].path;
      if (dirty & /*displayedItems*/
      2)
        feedcard_changes.url = /*fileData*/
        ctx[5].url;
      if (dirty & /*displayedItems*/
      2)
        feedcard_changes.tags = /*fileData*/
        ctx[5].tags;
      if (dirty & /*displayedItems*/
      2)
        feedcard_changes.content = /*fileData*/
        ctx[5].content;
      if (dirty & /*displayedItems*/
      2)
        feedcard_changes.createdMillis = /*fileData*/
        ctx[5].createdMillis;
...
function create_fragment39(ctx) {
  ...
  let t;
  let current;
  let if_block0 = !/*enablePremiumFeatures*/
...
function instance37($$self, $$props, $$invalidate) {
  let { enablePremiumFeatures = false } = $$props;
  let { data = [] } = $$props;
  let { startIndex } = $$props;
  let { pageLength } = $$props;
  let displayedItems = [];
  License.getInstance().getIsDeviceRegisteredStore().subscribe((isRegistered) => {
    $$invalidate(0, enablePremiumFeatures = isRegistered);
  });
  $$self.$$set = ($$props2) => {
    if ("enablePremiumFeatures" in $$props2)
      $$invalidate(0, enablePremiumFeatures = $$props2.enablePremiumFeatures);
    if ("data" in $$props2)
  ...
  $$self.$$.update = () => {
    ...
    28) {
      $: {
        if (startIndex < data.length) {
          $$invalidate(1, displayedItems = Array.from({ length: pageLength }, (_2, i) => {
            const index = startIndex + i;
            return data[index];
          }));
        } else {
          $$invalidate(1, displayedItems = []);
        }
      }
    }
  };
  return [enablePremiumFeatures, displayedItems, data, startIndex, pageLength];
}
var Feed_view = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance37, create_fragment39, safe_not_equal, {
      enablePremiumFeatures: 0,
      data: 2,
      startIndex: 3,
      pageLength: 4
    });
...
function create_fragment40(ctx) {
  ...
  return {
    c() {
      div = element("div");
      create_component(stack.$$.fragment);
      attr(div, "class", "vault-explorer-pagination-indicator");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      mount_component(stack, div, null);
...
var Pagination_indicator = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance38, create_fragment40, safe_not_equal, {
      startIndex: 0,
      endIndex: 1,
      currentPage: 2,
      totalPages: 3,
...
function create_default_slot_6(ctx) {
  ...
  let if_block0 = (
    /*timestampFilter*/
    ctx[2].isEnabled && create_if_block_52(ctx)
  );
  let if_block1 = (
    /*sortFilter*/
    ctx[3].isEnabled && create_if_block_43(ctx)
  );
  return {
    c() {
      if (if_block0)
...
function create_default_slot_5(ctx) {
  ...
  let if_block = (
    /*favoritesFilter*/
    ctx[1].isEnabled && create_if_block_62(ctx)
  );
  flex = new flex_default({
    props: {
...
function create_if_block_34(ctx) {
  let customfilter;
  let current;
  customfilter = new custom_filter_default({
    props: { groups: (
      /*customFilter*/
      ctx[4].groups
    ) }
  ...
  customfilter.$on("groupDragOver", handleGroupDragOver2);
  customfilter.$on("groupDragStart", handleGroupDragStart2);
  return {
    c() {
      create_component(customfilter.$$.fragment);
    },
    m(target, anchor) {
      mount_component(customfilter, target, anchor);
      current = true;
    },
    p(ctx2, dirty) {
      const customfilter_changes = {};
      if (dirty[0] & /*customFilter*/
      16)
        customfilter_changes.groups = /*customFilter*/
        ctx2[4].groups;
      customfilter.$set(customfilter_changes);
    },
    i(local) {
      if (current)
        return;
      transition_in(customfilter.$$.fragment, local);
      current = true;
    },
    o(local) {
      transition_out(customfilter.$$.fragment, local);
      current = false;
    },
    d(detaching) {
      destroy_component(customfilter, detaching);
    }
  };
}
...
function create_default_slot13(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "vault-explorer-view-select svelte-18ba0j6");
    },
    m(target, anchor) {
      insert(target, div, anchor);
...
function create_fragment41(ctx) {
  ...
  let if_block0 = (
    /*searchFilter*/
    ctx[0].isEnabled && create_if_block_7(ctx)
  );
  stack = new stack_default({
    props: {
      direction: "column",
  ...
  const if_block_creators = [create_if_block14, create_if_block_110, create_if_block_24];
  const if_blocks = [];
  ...
  return {
    c() {
      ...
      if (if_block1)
        if_block1.c();
      attr(div0, "class", "vault-explorer-header svelte-18ba0j6");
      attr(div1, "class", "vault-explorer svelte-18ba0j6");
    },
    m(target, anchor) {
      insert(target, div1, anchor);
      append(div1, div0);
...
function instance39($$self, $$props, $$invalidate) {
  ...
  store_default.plugin.subscribe((p) => __awaiter(void 0, void 0, void 0, function* () {
    $$invalidate(22, plugin2 = p);
    const { app, settings } = plugin2;
    $$invalidate(29, files = app.vault.getFiles());
    $$invalidate(26, pageSize = settings.pageSize);
    ...
    $$invalidate(31, dashboardView = settings.views.dashboard);
    $$invalidate(32, listView = settings.views.list);
    $$invalidate(33, gridView = settings.views.grid);
    $$invalidate(34, feedView = settings.views.feed);
    $$invalidate(35, tableView = settings.views.table);
    $$invalidate(36, recommendedView = settings.views.recommended);
    $$invalidate(37, relatedView = settings.views.related);
    $$invalidate(6, viewOrder = settings.viewOrder);
    if (settings.enableClockUpdates) {
      setTimeValuesUpdateInterval();
    }
    $$invalidate(30, contentForFiles = yield loadContentForFiles(files));
  }));
  onMount(() => {
    function handleFilterToggleSettingChange() {
      import_js_logger6.default.trace({
    ...
    EventManager.getInstance().on("filter-toggle-setting-change", handleFilterToggleSettingChange);
    return () => {
      EventManager.getInstance().off("filter-toggle-setting-change", handleFilterToggleSettingChange);
    };
  });
  onMount(() => {
    ...
    updateTimeValues();
    EventManager.getInstance().on("clock-updates-setting-change", handleClockUpdatesSettingChange);
    return () => {
      if (timeValuesUpdateInterval != null)
        clearInterval(timeValuesUpdateInterval);
      EventManager.getInstance().off("clock-updates-setting-change", handleClockUpdatesSettingChange);
    };
  });
  onMount(() => {
  ...
  onMount(() => {
    const handleCreateFile = (...data) => {
      ...
      if (data.length > 0 && data[0] instanceof import_obsidian13.TFile) {
        const newFile = data[0];
        $$invalidate(29, files = [...files, newFile]);
      }
    };
  ...
  onMount(() => {
    const handleDeleteFile = (...data) => {
      ...
      if (data.length > 0 && typeof data[0] === "string") {
        const path = data[0];
        $$invalidate(29, files = files.filter((file) => file.path !== path));
      }
    };
  ...
  onMount(() => {
    const handleFileRename = (...data) => {
      ...
      if (data.length < 2)
        return;
      if (typeof data[0] === "string" && data[1] instanceof import_obsidian13.TFile) {
        const oldPath = data[0];
        const updatedFile = data[1];
        $$invalidate(29, files = files.map((file) => {
  ...
  onMount(() => {
    const handleFileModify = (...data) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (data.length > 0 && data[0] instanceof import_obsidian13.TFile) {
        ...
        $$invalidate(30, contentForFiles = updatedContentForFiles);
      }
    });
  ...
  onMount(() => {
    ...
    EventManager.getInstance().on("view-toggle-setting-change", handleViewToggleSettingChange);
    return () => {
      EventManager.getInstance().off("view-toggle-setting-change", handleViewToggleSettingChange);
    };
  });
  onMount(() => {
    function handlePageSizeSettingChange() {
      ...
      $$invalidate(26, pageSize = plugin2.settings.pageSize);
    }
    EventManager.getInstance().on("page-size-setting-change", handlePageSizeSettingChange);
    return () => {
      EventManager.getInstance().off("page-size-setting-change", handlePageSizeSettingChange);
    };
  });
  onMount(() => {
    ...
    EventManager.getInstance().on("property-setting-change", handlePropertySettingChange);
    return () => {
      EventManager.getInstance().off("property-setting-change", handlePropertySettingChange);
    };
  });
  const debounceSearchFilterChange = import_lodash.default.debounce(
    (e) => {
  ...
  const debounceFavoriteFilterChange = import_lodash.default.debounce(
    (value) => {
  ...
  function updateTimeValues() {
    ...
    $$invalidate(23, startOfTodayMillis = getStartOfTodayMillis());
    $$invalidate(24, startOfThisWeekMillis = getStartOfThisWeekMillis());
    $$invalidate(25, startOfLastWeekMillis = getStartOfLastWeekMillis());
  }
  ...
  function loadContentForFiles(files2) {
    return __awaiter(this, void 0, void 0, function* () {
      const promises = [];
  ...
  function updateFrontmatterCacheTime() {
    ...
    $$invalidate(27, frontmatterCacheTime = Date.now());
  }
  function updatePropertySettingTime() {
    $$invalidate(28, propertySettingTime = Date.now());
  }
  function saveSettings() {
    return __awaiter(this, void 0, void 0, function* () {
      $$invalidate(22, plugin2.settings.filters.search = searchFilter, plugin2);
      $$invalidate(22, plugin2.settings.filters.sort = sortFilter, plugin2);
      $$invalidate(22, plugin2.settings.filters.timestamp = timestampFilter, plugin2);
      $$invalidate(22, plugin2.settings.filters.favorites = favoritesFilter, plugin2);
      $$invalidate(22, plugin2.settings.views.dashboard = dashboardView, plugin2);
      $$invalidate(22, plugin2.settings.views.list = listView, plugin2);
      $$invalidate(22, plugin2.settings.views.grid = gridView, plugin2);
      $$invalidate(22, plugin2.settings.views.feed = feedView, plugin2);
      $$invalidate(22, plugin2.settings.views.table = tableView, plugin2);
      $$invalidate(22, plugin2.settings.views.recommended = recommendedView, plugin2);
      $$invalidate(22, plugin2.settings.views.related = relatedView, plugin2);
      $$invalidate(22, plugin2.settings.currentView = currentView, plugin2);
      $$invalidate(22, plugin2.settings.filters.custom = customFilter, plugin2);
      $$invalidate(22, plugin2.settings.viewOrder = viewOrder, plugin2);
      yield plugin2.saveSettings();
    });
  }
  function handleGroupClick(e) {
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty[0] & /*frontmatterCacheTime, customFilter, files, plugin, contentForFiles*/
    1749024784) {
      $:
        if (frontmatterCacheTime && customFilter.groups) {
          console.log("Frontmatter cache time", frontmatterCacheTime);
          $$invalidate(38, filteredCustom = files.filter((file) => {
            var _a, _b, _c;
            const { name, path } = file;
            const frontmatter = (_a = plugin2.app.metadataCache.getFileCache(file)) === null || _a === void 0 ? void 0 : _a.frontmatter;
            let content = (_c = (_b = contentForFiles.find((content2) => content2.path === path)) === null || _b === void 0 ? void 0 : _b.content) !== null && _c !== void 0 ? _c : "";
            return filterByGroups(name, path, frontmatter, content, customFilter.groups);
          }));
        }
    }
    if ($$self.$$.dirty[0] & /*propertySettingTime, plugin, contentForFiles*/
    1346371584 | $$self.$$.dirty[1] & /*filteredCustom*/
    128) {
      $:
        if (propertySettingTime) {
          $$invalidate(39, formatted = filteredCustom.map((file) => {
            var _a, _b, _c;
            const frontmatter = (_a = plugin2.app.metadataCache.getFileCache(file)) === null || _a === void 0 ? void 0 : _a.frontmatter;
            const content = (_c = (_b = contentForFiles.find((content2) => content2.path === file.path)) === null || _b === void 0 ? void 0 : _b.content) !== null && _c !== void 0 ? _c : null;
            return formatFileDataForRender(plugin2.settings, file, frontmatter, content);
          }));
        }
    }
    ...
    256) {
      $:
        $$invalidate(42, filteredSearch = formatted.filter((file) => {
    ...
    2048) {
      $:
        $$invalidate(41, filteredFavorites = filteredSearch.filter((file) => {
    ...
    58720260 | $$self.$$.dirty[1] & /*filteredFavorites*/
    1024) {
      $:
        $$invalidate(40, filteredTimestamp = filteredFavorites.filter((file) => {
    ...
    8 | $$self.$$.dirty[1] & /*filteredTimestamp*/
    512) {
      $:
    ...
    1024) {
      $:
        $$invalidate(11, totalItems = renderData.length);
    }
    if ($$self.$$.dirty[0] & /*totalItems, pageSize*/
    67110912) {
      $:
        $$invalidate(13, totalPages = Math.ceil(totalItems / pageSize));
    }
    ...
    768) {
      $:
        $$invalidate(12, endIndex = startIndex + pageLength);
    }
  };
  return [
    searchFilter,
...
var App = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance39, create_fragment41, safe_not_equal, {}, null, [-1, -1]);
  }
};
var app_default = App;

// src/obsidian/vault-explorer-view.ts
var VaultExplorerView = class extends import_obsidian14.ItemView {
...
var stringToLogLevel = (value) => {
  switch (value) {
    case LOG_LEVEL_OFF:
      return import_js_logger7.default.OFF;
    case LOG_LEVEL_ERROR:
      return import_js_logger7.default.ERROR;
    case LOG_LEVEL_WARN:
      return import_js_logger7.default.WARN;
    case LOG_LEVEL_INFO:
      return import_js_logger7.default.INFO;
    case LOG_LEVEL_DEBUG:
      return import_js_logger7.default.DEBUG;
    case LOG_LEVEL_TRACE:
      return import_js_logger7.default.TRACE;
    default:
...
function create_fragment42(ctx) {
  ...
  let if_block1 = (
    /*message*/
    ctx[0] != null && create_if_block_25(ctx)
  );
  let if_block2 = (
    /*isDeviceRegistered*/
    ctx[1] === false && create_if_block_111(ctx)
  );
  let if_block3 = (
    /*isDeviceRegistered*/
    ctx[1] === true && create_if_block15(ctx)
  );
  return {
    c() {
      div4 = element("div");
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (value.length === LICENSE_KEY_LENGTH) {
        ...
        if (result) {
          ...
          EventManager.getInstance().emit("device-registration-change", true);
        } else {
  ...
  function handleButtonClick() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (result) {
        ...
        $$invalidate(0, message = null);
        EventManager.getInstance().emit("device-registration-change", false);
      } else {
        const responseMessage = License.getInstance().getResponseMessage();
        $$invalidate(0, message = { type: "failure", text: responseMessage });
      }
...
// src/obsidian/vault-explorer-settings-tab.ts
var VaultExplorerSettingsTab = class extends import_obsidian15.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian15.Setting(containerEl).setName("Filters").setHeading();
    new import_obsidian15.Setting(containerEl).setName("Search filter").addToggle((toggle) => toggle.setValue(this.plugin.settings.filters.search.isEnabled).onChange(async (value) => {
      this.plugin.settings.filters.search.isEnabled = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("filter-toggle-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Favorites filter").addToggle((toggle) => toggle.setValue(this.plugin.settings.filters.favorites.isEnabled).onChange(async (value) => {
      this.plugin.settings.filters.favorites.isEnabled = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("filter-toggle-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Timestamp filter").addToggle((toggle) => toggle.setValue(this.plugin.settings.filters.timestamp.isEnabled).onChange(async (value) => {
      this.plugin.settings.filters.timestamp.isEnabled = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("filter-toggle-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Sort filter").addToggle((toggle) => toggle.setValue(this.plugin.settings.filters.sort.isEnabled).onChange(async (value) => {
      this.plugin.settings.filters.sort.isEnabled = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("filter-toggle-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Custom filter").addToggle((toggle) => toggle.setValue(this.plugin.settings.filters.custom.isEnabled).onChange(async (value) => {
      this.plugin.settings.filters.custom.isEnabled = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("filter-toggle-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Views").setHeading();
    new import_obsidian15.Setting(containerEl).setName("Dashboard view").addToggle((toggle) => toggle.setDisabled(true).setValue(this.plugin.settings.views.dashboard.isEnabled).onChange(async (value) => {
    ...
    new import_obsidian15.Setting(containerEl).setName("Grid view").addToggle((toggle) => toggle.setValue(this.plugin.settings.views.grid.isEnabled).onChange(async (value) => {
      this.plugin.settings.views.grid.isEnabled = value;
      this.updateViewOrder("grid" /* GRID */, value);
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("view-toggle-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("List view").addToggle((toggle) => toggle.setValue(this.plugin.settings.views.list.isEnabled).onChange(async (value) => {
      this.plugin.settings.views.list.isEnabled = value;
      this.updateViewOrder("list" /* LIST */, value);
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("view-toggle-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Feed view").addToggle((toggle) => toggle.setValue(this.plugin.settings.views.feed.isEnabled).onChange(async (value) => {
      this.plugin.settings.views.feed.isEnabled = value;
      this.updateViewOrder("feed" /* FEED */, value);
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("view-toggle-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Table view").addToggle((toggle) => toggle.setDisabled(true).setTooltip("This view is not yet implemented.").setValue(this.plugin.settings.views.table.isEnabled).onChange(async (value) => {
      this.plugin.settings.views.table.isEnabled = value;
      this.updateViewOrder("table" /* TABLE */, value);
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("view-toggle-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Recommended view").addToggle((toggle) => toggle.setValue(this.plugin.settings.views.recommended.isEnabled).setDisabled(true).setTooltip("This view is not yet implemented.").onChange(async (value) => {
      this.plugin.settings.views.recommended.isEnabled = value;
      this.updateViewOrder("recommended" /* RECOMMENDED */, value);
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("view-toggle-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Related view").addToggle((toggle) => toggle.setDisabled(true).setTooltip("This view is not yet implemented.").setValue(this.plugin.settings.views.related.isEnabled).onChange(async (value) => {
    ...
    new import_obsidian15.Setting(containerEl).setName("Page size").setDesc("The number of items to display per page.").addDropdown((dropdown) => dropdown.addOptions({
      "10": "10",
      "25": "25",
      "50": "50",
      "100": "100",
    ...
    new import_obsidian15.Setting(containerEl).setName("Title wrapping").setDesc(
      ...
      cb.setValue(this.plugin.settings.titleWrapping).onChange(
        async (value) => {
          this.plugin.settings.titleWrapping = value;
          await this.plugin.saveSettings();
          EventManager.getInstance().emit("title-wrapping-setting-change");
        }
      );
    });
    new import_obsidian15.Setting(containerEl).setName("Enable scroll buttons").setDesc("When enabled, scroll buttons will be displayed for scrollable content.").addToggle((toggle) => toggle.setValue(this.plugin.settings.enableScrollButtons).onChange(async (value) => {
      this.plugin.settings.enableScrollButtons = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("scroll-buttons-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Built-in properties").setHeading();
    new import_obsidian15.Setting(containerEl).setName("Favorite property").setDesc("The property used to mark a note as a favorite. This must be a checkbox property.").addDropdown((dropdown) => dropdown.addOptions(getDropdownOptionsForProperties(checkboxProperties)).setValue(this.plugin.settings.properties.favorite).onChange(async (value) => {
      this.plugin.settings.properties.favorite = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("property-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("URL property").setDesc("The property used to store the URL of the content. This must be a text property.").addDropdown((dropdown) => dropdown.addOptions(getDropdownOptionsForProperties(textProperties)).setValue(this.plugin.settings.properties.url).onChange(async (value) => {
    ...
    new import_obsidian15.Setting(containerEl).setName("Created date property").setDesc(createdDateDesc).addDropdown((dropdown) => dropdown.addOptions(getDropdownOptionsForProperties([...dateProperties, ...dateTimeProperties])).setValue(this.plugin.settings.properties.createdDate).onChange(async (value) => {
    ...
    new import_obsidian15.Setting(containerEl).setName("Modified date property").setDesc(modifiedDateDesc).addDropdown((dropdown) => dropdown.addOptions(getDropdownOptionsForProperties([...dateProperties, ...dateTimeProperties])).setValue(this.plugin.settings.properties.modifiedDate).onChange(async (value) => {
      this.plugin.settings.properties.modifiedDate = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("property-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Custom properties").setHeading();
    new import_obsidian15.Setting(containerEl).setName("Custom property 1").setDesc("The first custom property. This must be a text property.").addDropdown((dropdown) => dropdown.addOptions(getDropdownOptionsForProperties(textProperties)).setValue(this.plugin.settings.properties.custom1).onChange(async (value) => {
      this.plugin.settings.properties.custom1 = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("property-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Custom property 2").setDesc("The second custom property. This must be a text property.").addDropdown((dropdown) => dropdown.addOptions(getDropdownOptionsForProperties(textProperties)).setValue(this.plugin.settings.properties.custom2).onChange(async (value) => {
      this.plugin.settings.properties.custom2 = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("property-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Custom property 3").setDesc("The third custom property. This must be a text property.").addDropdown((dropdown) => dropdown.addOptions(getDropdownOptionsForProperties(textProperties)).setValue(this.plugin.settings.properties.custom3).onChange(async (value) => {
      this.plugin.settings.properties.custom3 = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("property-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Updates").setHeading();
    new import_obsidian15.Setting(containerEl).setName("Enable clock updates").setDesc("When enabled, time values will update every minute, refreshing the Vault Explorer view. When disabled, time values will only update when the view is first opened.").addToggle((toggle) => toggle.setValue(this.plugin.settings.enableClockUpdates).onChange(async (value) => {
      this.plugin.settings.enableClockUpdates = value;
      await this.plugin.saveSettings();
      EventManager.getInstance().emit("clock-updates-setting-change");
    }));
    new import_obsidian15.Setting(containerEl).setName("Premium").setHeading();
    this.component = new license_key_app_default({
      target: containerEl
    });
    new import_obsidian15.Setting(containerEl).setName("Debugging").setHeading();
    new import_obsidian15.Setting(containerEl).setName("Log level").setDesc(
      ...
      cb.setValue(this.plugin.settings.logLevel).onChange(
        async (value) => {
          ...
          await this.plugin.saveSettings();
          import_js_logger8.default.setLevel(stringToLogLevel(value));
        }
      );
    });
  }
...
// src/main.ts
var VaultExplorerPlugin = class extends import_obsidian16.Plugin {
  constructor() {
    super(...arguments);
  ...
  async saveSettings() {
    import_js_logger9.default.trace({ fileName: "main.ts", functionName: "saveSettings", message: "called" });
    import_js_logger9.default.debug({ fileName: "main.ts", functionName: "saveSettings", message: "saving settings" }, this.settings);
  ...
  setupLogger() {
    ...
    import_js_logger9.default.setHandler(function(messages, context) {
      const { message, data } = formatMessageForLogger(...messages);
      if (context.level === import_js_logger9.default.WARN) {
        console.warn(message);
        if (data) {
          console.warn(data);
        }
      } else if (context.level === import_js_logger9.default.ERROR) {
    ...
    import_js_logger9.default.setLevel(logLevel);
  }
};
